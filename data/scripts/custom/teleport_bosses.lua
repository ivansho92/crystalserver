local config = {
    ...
    { name="Grand Master Oberon", position = Position(33364, 31341, 9) },
	...
	{ name="Leiden", position = Position(33138, 31958, 15) },
	{ name="Ratmiral Blackwhiskers", position = Position(33898, 31388, 15) },
	{ name="Arbaziloth", position = Position(34058, 32401, 14) },
	{ name="The Destruction", position = Position(32272, 31381, 14) },
...
function teleportBoss.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	-- VERIFICACIÓN DE COMBATE
	if player:isPzLocked() or player:getCondition(CONDITION_INFIGHT, CONDITIONID_DEFAULT) then
		player:sendTextMessage(MESSAGE_EVENT_ADVANCE, "You can't use this while in combat.")
